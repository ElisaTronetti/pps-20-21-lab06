...
import Assertions._
import u06lab.code.ConvertToChar.StringParser
...
class TryParsers {
  ...
  @Test def testStringParser() {
    assertTrue(sparser.parseAll("abc".toList))
